...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sass>, ["~> 3.1", "<= 3.2.19"])
      s.add_runtime_dependency(%q<tilt>, ["~> 1.3", "<= 1.4.1"])
      s.add_runtime_dependency(%q<compass>, ["~> 0.12.1"])
      s.add_runtime_dependency(%q<rack>, ["~> 2.2.3"])
      s.add_runtime_dependency(%q<thor>, ["~> 1.1.0"])
      ...
      s.add_dependency(%q<sass>, ["~> 3.1", "<= 3.2.19"])
      s.add_dependency(%q<tilt>, ["~> 1.3", "<= 1.4.1"])
      s.add_dependency(%q<compass>, ["~> 0.12.1"])
      s.add_dependency(%q<rack>, ["~> 2.2.3"])
      s.add_dependency(%q<thor>, ["~> 1.1.0"])
      s.add_dependency(%q<aws-s3>, ["~> 0.6.3"])
